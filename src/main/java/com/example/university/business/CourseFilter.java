...
public class CourseFilter {
    ...
    public Specification<Course> getSpecification() {
        return (root, query, criteriaBuilder) -> {
            ...
            credits.ifPresent(s -> predicates.add(criteriaBuilder.equal(root.get("credits"), s)));
    ...
    public Example<Course> getExampleProbe() {
        return Example.of(
                new Course(null, credits.orElse(null), instructor.orElse(null), department.orElse(null))
        );
    }
